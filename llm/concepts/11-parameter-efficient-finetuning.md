...
## Related Topics
- [LoRA](08-lora.md) — specific PEFT variant
- [Fine-tuning](04-finetuning.md) — full FT baseline
- [Adapters](09-adapters.md) — another PEFT method
- [Quantization](30-quantization.md) — orthogonal technique for compression
