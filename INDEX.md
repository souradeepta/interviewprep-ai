# Complete Index — ML/AI Interview Prep Hub
...
- [Class Imbalance](ml/concepts/class-imbalance.md)
- [Data Leakage](ml/concepts/data-leakage.md)

**Training & Tuning**
- [Cross-Validation Strategies](ml/concepts/cross-validation-strategies.md)
- [Hyperparameter Tuning](ml/concepts/hyperparameter-tuning.md)
- [Model Selection](ml/concepts/model-selection.md)
- [Overfitting & Underfitting](ml/concepts/overfitting-underfitting.md)

**Deep Learning Core**
- [Activation Functions](ml/concepts/activation-functions.md)
- [Loss Functions](ml/concepts/loss-functions.md)
- [Weight Initialization](ml/concepts/weight-initialization.md)
- [Batch Normalization](ml/concepts/batch-normalization.md)
- [Layer Normalization](ml/concepts/layer-normalization.md)
- [Dropout](ml/concepts/dropout.md)

**Training Techniques**
- [Early Stopping](ml/concepts/early-stopping.md)
- [Learning Rate Schedules](ml/concepts/learning-rate-schedules.md)
- [Momentum & Acceleration](ml/concepts/momentum-and-acceleration.md)
- [Gradient Accumulation](ml/concepts/gradient-accumulation.md)
- [Mixed Precision Training](ml/concepts/mixed-precision-training.md)

**Scaling & Optimization**
- [Distributed Training](ml/concepts/distributed-training.md)
- [Model Compression](ml/concepts/model-compression.md)
- [Quantization](ml/concepts/quantization.md)
- [Pruning](ml/concepts/pruning.md)
- [Knowledge Distillation](ml/concepts/knowledge-distillation.md)

**Transfer & Adaptation**
- [Transfer Learning](ml/concepts/transfer-learning.md)
- [Domain Adaptation](ml/concepts/domain-adaptation.md)
...
3. [Agentic AI Roadmap](roadmaps/agentic-roadmap.md) — 4-6 weeks, 3 phases
4. [System Design Roadmap](roadmaps/system-design-roadmap.md) — 4-6 weeks, 3 phases
5. [Roadmaps Overview](roadmaps/README.md) — Guide to all paths
...
**By learning goal:**
- Want to master ML fundamentals? → [ML Roadmap](roadmaps/ml-roadmap.md)
- Preparing for LLM engineering interviews? → [LLM Roadmap](roadmaps/llm-roadmap.md)
- Building AI agents? → [Agentic AI Roadmap](roadmaps/agentic-roadmap.md)
- System design round? → [System Design Roadmap](roadmaps/system-design-roadmap.md)

**By format:**
- Want to read concepts? → Pick a category above and start with detailed files
- Want to code? → [All 8 notebooks](ml/implementations/)
