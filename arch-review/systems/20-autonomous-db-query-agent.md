...
## TL;DR
Converts natural language to SQL, runs queries, explains results. 1K queries/day, 90% correctness.

## Problem Statement
Non-technical users can't write SQL. Need intelligent translation.
