...
## TL;DR
Agents collect financial data, analyze fundamentals, generate reports. 100 companies/day, <30 min per report, 85% accuracy vs human analysts.

## Problem Statement
Equity research expensive ($100K+/year analyst). Need automated generation at scale.
