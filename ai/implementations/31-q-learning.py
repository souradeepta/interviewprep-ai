...
# Level 1: Core QLearning concept from scratch
...
class QLearningProduction:

    """Productionready q-learning with optimization."""
...
model = QLearningProduction(learning_rate=0.01)
...
plt.title('QLearning - Training Loss')
...
# Example 1: QLearning for Classification
