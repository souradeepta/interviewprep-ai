...
Version 2: Improved matching logic for headers.
"""
...
# Real-world templates organized by notebook
# Each notebook has a list of (example_key, code) tuples
# example_key is matched against "Real-World Example N: <key>" format

NOTEBOOK_UPGRADES = {
    '01-data-pipelines.ipynb': [
        ('Netflix Feature Pipeline', '''import pandas as pd
import numpy as np
...
'''),
        ('Uber Real-Time Pricing', '''import time
import numpy as np
...
'''),
        ('Stripe Fraud Detection', '''import pandas as pd
import numpy as np
...
'''),
    ...
    '02-feature-stores.ipynb': [
        ('Netflix Feature Store', '''import pandas as pd
import numpy as np
...
'''),
        ('Uber Feature Store', '''import pandas as pd
...
'''),
    ...
    '03-data-validation.ipynb': [
        ('Netflix Content Metadata', '''import pandas as pd
import numpy as np
...
'''),
    ...
    '10-data-testing.ipynb': [
        ('Stripe Transaction Validation', '''import pandas as pd
import numpy as np
...
def main():
    ...
    print("UPGRADING NOTEBOOKS WITH FUNCTIONAL REAL-WORLD EXAMPLES")
    print("=" * 70)
    ...
    print("\n✓ Upgrade complete! Notebooks now have functional examples.")
